    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0f172a] flex items-center justify-center p-6 transition-colors duration-300">
      ...
      >
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-10 leading-relaxed">
          Pesanan Anda telah tercatat. Silakan selesaikan pembayaran sebelum
        ...
        <div className="space-y-4">
          {token && (
            <button
              ...
              disabled={loading}
              className="block w-full py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold transition-all shadow-lg shadow-blue-500/30 disabled:opacity-70"
            >
              {loading
                ? "Membuka Instruksi..."
